...
public:
    bool closeStrings(string word1, string word2) {
        ...
        return word1FrequencyList == word2FrequencyList; // this is very very smart
    }
};
// if the characters are the same, they can be close
// check that the lengths of the string are the same