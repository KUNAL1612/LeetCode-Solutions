class Solution {
    public double[] calcEquation(List<List<String>> equations, double[] values,
        ...
        for (int i = 0; i < equations.size(); i++) {
            ...
            graph.get(dividend).put(divisor, quotient); // a to b
            graph.get(divisor).put(dividend, 1 / quotient); // b to a
        }
        
        /// map[top].append(bottom, quotient);
        // map[bottom].append(top, 1/qoutent);
